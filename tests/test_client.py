...
from joplin_mcp.client import JoplinClientError, JoplinMCPClient
...
class TestJoplinMCPClientInitialization:
    ...
    def test_client_initializes_with_config_object(self):
        ...
        with patch("joppy.client_api.ClientApi") as mock_client_api:
            ...
            mock_client_api.assert_called_once_with(
                token="test-token", url="https://localhost:41184"
            )
    ...
    def test_client_initializes_with_config_parameters(self):
        ...
        with patch("joppy.client_api.ClientApi") as mock_client_api:
            ...
            # Should create joppy ClientApi with correct parameters
            mock_client_api.assert_called_once_with(
                token="my-token-123", url="http://example.com:8080"
            )
    ...
    def test_client_initializes_with_mixed_config_and_overrides(self):
        ...
        config = JoplinMCPConfig(
            host="localhost", port=41184, token="config-token", timeout=30
        )
        ...
        with patch("joppy.client_api.ClientApi") as mock_client_api:
            ...
            mock_client_api.assert_called_once_with(
                token="override-token", url="https://localhost:9999"
            )
    ...
    def test_client_handles_joppy_import_error(self):
        ...
        with patch(
            "joppy.client_api.ClientApi",
            side_effect=ImportError("No module named 'joppy'"),
        ):
...
class TestJoplinMCPClientErrorHandling:
    ...
    def test_client_provides_helpful_error_context(self):
        ...
        config = JoplinMCPConfig(
            host="unreachable-host", port=41184, token="test-token"
        )
    ...
    def test_client_transforms_joppy_search_results_to_mcp_search_result(self):
        ...
        with patch("joppy.client_api.ClientApi") as mock_client_api:
            ...
            mcp_search_result = client.transform_search_results_to_mcp(
                mock_joppy_notes, has_more=False, total_count=3
            )
...
class TestJoplinMCPClientEnhancedSearch:
    ...
    def test_enhanced_search_with_query_string(self, client, mock_joppy_notes):
        ...
        with patch.object(
            client, "_execute_joppy_search", return_value=mock_joppy_notes
        ):
        ...
        with patch.object(
            ...
            result = client.enhanced_search(
                ...
                filters={
                    ...
                    "is_todo": True,
                    "date_range": {"start": 1640995200000, "end": 1641254400000},
                },
                limit=20,
                include_body=False,
            )
    ...
    def test_enhanced_search_with_pagination(self, client, mock_joppy_notes):
        ...
        with patch.object(
            ...
            result = client.enhanced_search(
                query="test", limit=5, offset=10, return_pagination_info=True
            )
    ...
    def test_enhanced_search_with_highlighting(self, client, mock_joppy_notes):
        ...
        with patch.object(
            ...
            if result.items:
                highlighted_fields = [
                    k for k in result.items[0].keys() if k.endswith("_highlighted")
                ]
    ...
    def test_enhanced_search_with_related_content(self, client, mock_joppy_notes):
        ...
        with patch.object(
            ...
            result = client.enhanced_search(
                query="meeting", include_related=True, related_limit=3
            )
    ...
    def test_enhanced_search_returns_mcp_optimized_response(
        self, client, mock_joppy_notes
    ):
    ...
    def test_enhanced_search_with_field_specific_queries(
        self, client, mock_joppy_notes
    ):
        ...
        with patch.object(
            ...
            result = client.enhanced_search(
                query="title:meeting body:project", enable_field_queries=True
            )
    ...
    def test_enhanced_search_with_date_range_queries(self, client, mock_joppy_notes):
        ...
        with patch.object(
            ...
            result = client.enhanced_search(
                query="created:[2022-01-01 TO 2022-12-31]", enable_date_queries=True
            )
    ...
    def test_enhanced_search_with_autocomplete_suggestions(
        self, client, mock_joppy_notes
    ):
        """Test enhanced search with autocomplete/suggestion functionality."""
        suggestions = client.get_search_suggestions(
            partial_query="meet", max_suggestions=5, include_recent_searches=True
        )
    ...
    def test_enhanced_search_with_export_capabilities(self, client, mock_joppy_notes):
        ...
        with patch.object(
            ...
            json_export = client.export_search_results(
                result, format="json", include_metadata=True
            )
    ...
    def test_enhanced_search_with_streaming(self, client, mock_joppy_notes):
        ...
        with patch.object(
            ...
            stream = client.enhanced_search(
                query="test", stream_results=True, batch_size=1
            )
    ...
    def test_enhanced_search_performance_with_large_results(
        self, client, mock_joppy_notes
    ):
        ...
        with patch.object(client, "_execute_joppy_search", return_value=large_results):
            ...
            stream = client.enhanced_search(
                query="test", stream_results=True, batch_size=100
            )
            ...
            for batch in stream:
                ...
                if (
                    total_items >= 200
                ):  # Process only first 200 items to avoid long test
                    break
    ...
    def test_enhanced_search_with_caching(self, client, mock_joppy_notes):
        ...
        with patch.object(
            ...
            result1 = client.enhanced_search(
                query="test", enable_cache=True, cache_ttl=60
            )
...
class TestJoplinMCPClientNoteOperations:
    ...
    def test_get_note_with_invalid_id(self, client):
        ...
        with patch.object(
            client.api, "get_note", side_effect=Exception("Note not found")
        ):
    ...
    def test_create_note_with_valid_data(self, client, sample_note_data):
        ...
        with patch.object(
            ...
            "add_note",
            return_value="note123456789012345678901234567890",
        ) as mock_add_note:
    ...
    def test_create_note_with_missing_required_fields(self, client):
        ...
        with pytest.raises(TypeError):
            ...
            client.create_note(
                body="Content", parent_id="1234567890abcdef1234567890abcdef"
            )
    ...
    def test_update_note_with_invalid_id(self, client):
        ...
        with patch.object(
            client.api, "modify_note", side_effect=Exception("Note not found")
        ):
    ...
    def test_update_note_with_empty_data(self, client):
        ...
        with pytest.raises(
            JoplinClientError, match="At least one field must be provided for update"
        ):
    ...
    def test_delete_note_with_invalid_id(self, client):
        ...
        with patch.object(
            client.api, "delete_note", side_effect=Exception("Note not found")
        ):
    ...
    def test_note_operations_with_connection_failure(self, client):
        ...
        with patch.object(
            client._joppy_client, "get_note", side_effect=Exception("Connection failed")
        ):
            with pytest.raises(JoplinClientError, match="Failed to get note"):
        ...
        with patch.object(
            client._joppy_client, "add_note", side_effect=Exception("Connection failed")
        ):
            with pytest.raises(JoplinClientError, match="Failed to create note"):
                client.create_note(
                    title="Test", parent_id="notebook12345678901234567890123456"
                )
    ...
    def test_bulk_note_operations(self, client):
        ...
        with patch.object(client._joppy_client, "get_note", side_effect=mock_notes):
            with patch.object(
                client,
                "transform_note_to_mcp",
                side_effect=lambda note: MCPNote(
                    id=note.id,
                    title=note.title,
                    body=note.body,
    ...
    def test_note_validation_with_mcp_constraints(self, client):
        ...
        with pytest.raises(
            JoplinClientError, match="Title contains invalid characters"
        ):
    ...
    def test_note_operations_with_custom_metadata(self, client):
        ...
        with patch.object(
            client._joppy_client,
            "add_note",
            return_value="meta123456789abcdef123456789ab",
        ) as mock_add_note:
    ...
    def test_note_validation_with_mcp_constraints(self, client):
        ...
        with pytest.raises(JoplinClientError, match="Title too long"):
            client.create_note(
                title=long_title, parent_id="notebook12345678901234567890123456"
            )
        ...
        with pytest.raises(JoplinClientError, match="Note body too large"):
            client.create_note(
                title="Test",
                body=large_body,
                parent_id="notebook12345678901234567890123456",
            )
        ...
        with pytest.raises(
            ...
            client.create_note(
                title=invalid_title, parent_id="notebook12345678901234567890123456"
            )
    ...
    def test_create_note_with_invalid_parent_id(self, client):
        ...
        with pytest.raises(
            JoplinClientError, match="Invalid parent notebook ID format"
        ):
...
class TestJoplinMCPClientNotebookOperations:
    ...
    def test_get_notebook_with_valid_id(self, client, sample_notebook_data):
        ...
        with patch.object(
            client._joppy_client, "get_folder", return_value=mock_joppy_notebook
        ):
    ...
    def test_create_notebook_with_valid_data(self, client):
        ...
        create_data = {"title": "New Test Notebook", "parent_id": None}  # Root notebook
    ...
    def test_update_notebook_with_empty_data(self, client):
        ...
        with pytest.raises(
            JoplinClientError, match="At least one field must be provided"
        ):
    ...
    def test_delete_notebook_with_invalid_id(self, client):
        ...
        with patch.object(client, "get_all_notebooks", return_value=[]):
            with patch.object(
                ...
                with pytest.raises(
                    JoplinClientError, match="Failed to delete notebook"
                ):
    ...
    def test_delete_notebook_with_children_protection(self, client):
        ...
        with patch.object(client, "get_all_notebooks", return_value=[child_notebook]):
            with pytest.raises(
                JoplinClientError, match="Cannot delete notebook with children"
            ):
...
class TestJoplinMCPClientTagOperations:
    ...
    def test_get_tag_with_invalid_id(self, client):
        ...
        with patch.object(
            client._joppy_client, "get_tag", side_effect=Exception("Tag not found")
        ):
    ...
    def test_get_tags_by_note(self, client):
        ...
        with patch.object(
            client._joppy_client, "get_note_tags", return_value=mock_tags
        ):
    ...
    def test_create_tag_with_valid_data(self, client):
        ...
        create_data = {"title": "new-test-tag"}

        with patch.object(
            client._joppy_client,
            "add_tag",
            return_value="1234567890abcdef1234567890abcdef",
        ):
    ...
    def test_update_tag_with_invalid_id(self, client):
        ...
        with patch.object(
            client._joppy_client, "modify_tag", side_effect=Exception("Tag not found")
        ):
    ...
    def test_delete_tag_with_invalid_id(self, client):
        ...
        with patch.object(
            client._joppy_client, "delete_tag", side_effect=Exception("Tag not found")
        ):
    ...
    def test_get_unused_tags(self, client):
        ...
        with patch.object(client, "get_all_tags", return_value=all_tags):
            with patch.object(
                client._joppy_client, "get_all_notes", return_value=mock_notes
            ):
                with patch.object(
                    client, "get_tags_by_note", return_value=[all_tags[0]]
    ...
    def test_get_popular_tags(self, client):
        ...
        with patch.object(client, "get_all_tags", return_value=all_tags):
            with patch.object(
                ...
                with patch.object(
                    client, "get_tags_by_note", side_effect=mock_get_tags_by_note
                ):
    ...
    def test_update_tag_with_valid_data(self, client):
        ...
        update_data = {"title": "updated-tag-title"}
    ...
    def test_tag_operations_with_connection_failure(self, client):
        ...
        with patch.object(
            client._joppy_client, "get_tag", side_effect=Exception("Connection failed")
        ):
            with pytest.raises(JoplinClientError, match="Failed to get tag"):
...
class TestJoplinMCPClientConnectionManagement:
    ...
    def client(self):
        ...
        config = JoplinMCPConfig(
            host="localhost", port=41184, token="test-token", timeout=10
        )
