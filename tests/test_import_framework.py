...
from joplin_mcp.types.import_types import ImportedNote, ImportResult, ImportOptions
from joplin_mcp.importers.base import BaseImporter, ImportError, ImportValidationError
...
class TestImportedNote:
    ...
    def test_title_from_body_when_empty(self):
        ...
        note = ImportedNote(
            title="",
            body="This should become the title\nSecond line"
        )
...
class TestJoplinImportEngine:
    ...
    async def test_ensure_notebook_creation(self, mock_client, mock_config):
        ...
        notebook_id = await engine.ensure_notebook_exists("New Notebook", options, result)
